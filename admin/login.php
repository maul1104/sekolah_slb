                ...
                <div class="row">
                    <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                        <div class="login-brand">
                            <img src="<?= $base_url ?>assets/img/logo-slbanimha.png" alt="logo" width="150" class="shadow-light rounded" style="padding: 10px;">
                            <h4 class="mt-3">SEKOLAH LUAR BIASA (SLB) ANIMHA MERAUKE </h4>
                        </div><center><p>Repost by <a href='https://stokcoding.com/' title='StokCoding.com' target='_blank'>StokCoding.com</a></p></center>
