    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" name="golongan" id="" class="form-control" required>
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form action="<?= $base_url ?>proses_admin/data_guru/update.php" method="post" enctype='multipart/form-data'>
        <div class="modal-body">
            ...
            <div class="form-group">
              <label for="">NIP</label>
              <input type="text" name="nip" id="" class="form-control" required value = "<?= $row['nip'] ?>">
            </div>
            <div class="form-group">
              <label for="">Golongan</label>
              <input type="text" name="golongan" id="" class="form-control" required value = "<?= $row['golongan'] ?>">
            </div>
            <div class="form-group">
              <label for="">Email</label>
